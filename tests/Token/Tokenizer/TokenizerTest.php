    ...
    public function testTokenizeWithCustomOperators(): void
    {
        ...
        static::assertEquals(
            [
                ...
                new Token(Token::UNARY_OPERATOR_TYPE, 1, 4, $filePath, 'n0t'),
                new Token(Token::WHITESPACE_TYPE, 1, 7, $filePath, ' '),
                new Token(Token::NAME_TYPE, 1, 8, $filePath, 'foo'),
                new Token(Token::OPERATOR_TYPE, 1, 11, $filePath, '.'),
                ...
                new Token(Token::UNARY_OPERATOR_TYPE, 1, 21, $filePath, '+'),
    ...
    public static function tokenizeDataProvider(): iterable
    {
        ...
        yield [
            ...
            [
                ...
                19 => Token::TERNARY_OPERATOR_TYPE,
                20 => Token::WHITESPACE_TYPE,
                21 => Token::STRING_TYPE,
                22 => Token::WHITESPACE_TYPE,
                23 => Token::TERNARY_OPERATOR_TYPE,
                ...
                65 => Token::TERNARY_OPERATOR_TYPE,
                66 => Token::WHITESPACE_TYPE,
                67 => Token::NAME_TYPE,
                68 => Token::WHITESPACE_TYPE,
                69 => Token::TERNARY_OPERATOR_TYPE,
                ...
                90 => Token::TERNARY_OPERATOR_TYPE,
        ...
        yield [
            ...
            [
                ...
                7 => Token::WHITESPACE_TYPE,
                8 => Token::TERNARY_OPERATOR_TYPE,
                9 => Token::WHITESPACE_TYPE,
                10 => Token::NAME_TYPE,
                11 => Token::OPERATOR_TYPE,
        ...
        yield [
            __DIR__.'/Fixtures/test20.twig',
            [
                0 => Token::VAR_START_TYPE,
                1 => Token::WHITESPACE_TYPE,
                2 => Token::NAME_TYPE,
                3 => Token::PUNCTUATION_TYPE,
                4 => Token::UNARY_OPERATOR_TYPE,
                5 => Token::UNARY_OPERATOR_TYPE,
                6 => Token::NUMBER_TYPE,
                7 => Token::PUNCTUATION_TYPE,
                8 => Token::WHITESPACE_TYPE,
                9 => Token::VAR_END_TYPE,
                10 => Token::EOL_TYPE,
                11 => Token::EOF_TYPE,
            ],
        ];
