...
final class TokenizerTest extends TestCase
{
    ...
    public function tokenizeInvalidDataProvider(): iterable
    {
        ...
        yield [__DIR__.'/TokenizerTestInvalid2.twig', 'Unexpected character "&".'];
        yield [__DIR__.'/TokenizerTestInvalid3.twig', 'Unclosed "(".'];
        yield [__DIR__.'/TokenizerTestInvalid4.twig', 'Unexpected ")".'];
    }
}
