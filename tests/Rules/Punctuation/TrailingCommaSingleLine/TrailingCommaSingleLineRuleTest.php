...
final class TrailingCommaSingleLineRuleTest extends AbstractRuleTestCase
{
    public function testRule(): void
    {
        $this->checkRule(new TrailingCommaSingleLineRule(), [
            ...
            'TrailingCommaSingleLine.Error:37:18' => 'Single-line arrays, objects and parameters lists should not have trailing comma.',
            'TrailingCommaSingleLine.Error:40:16' => 'Single-line arrays, objects and parameters lists should not have trailing comma.',
        ]);
    }
}
